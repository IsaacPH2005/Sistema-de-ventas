...
let posicion = null;
const listar = () => {
    let tabla = document.querySelector('#tablaProveedor tbody');
    let filas = '';
...
const mostrar = param => {
    document.getElementById('nombreProveedorModal').value = proveedores[param].nombre;
    document.getElementById('apellidoProveedorModal').value = proveedores[param].apellido;
    document.getElementById('identificacionProveedorModal').value = proveedores[param].identificacion;
    document.getElementById('contactoProveedorModal').value = proveedores[param].contacto;
    posicion = param;
    instanciaModal.show();
}
const editar = () => {
    let nombre = document.getElementById('nombreProveedorModal').value;
    let apellido = document.getElementById('apellidoProveedorModal').value;
    let identificacion = document.getElementById('identificacionProveedorModal').value;
    let contacto = document.getElementById('contactoProveedorModal').value;
